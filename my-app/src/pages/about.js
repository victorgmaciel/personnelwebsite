            ...
            <div className='container row justify-content-center'>
                <Card className='card text-center' style={{ width: '20rem' }} border='light'>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            I served onboard a U.S. Submarine for five years. I was an auxiliary mechanic. I worked on hydraulic plants,oxygen systems, atmosphere control etc. Ask me to tell you a sea story!
                        </Card.Text>
                    </Card.Body>
                </Card>
